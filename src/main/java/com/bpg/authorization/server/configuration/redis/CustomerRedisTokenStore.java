...
public class CustomerRedisTokenStore implements CustomerTokenStore {
    ...
    public Md5TokenHolder save(TokenHolder tokenHolder, Long accessTokenStoreSeconds, Long refreshTokenStoreSeconds) {
        ...
        TokenContainer tokenContainer = TokenContainer.of(tokenHolder, md5TokenHolder);
    ...
    public TokenContainer find(Md5TokenHolder tokenHolder) {
        ...
        return TokenContainer.of(null, null);
    }
    ...
    @Override
    public void remove(TokenContainer tokenContainer) {
